...
const ReviewTile = (props) => {
  ...
  return (
    <div style={{backgroundColor: "#f2g2g2", padding:"10px", paddingLeft:"10px"}}  >
      ...
      <p style={{paddingBottom: "10px"}}><Recommend recommend={props.value.recommend}/></p>
      <div style={{color: "#4c4c4b"}}>
      <Response response={props.value.response} style={{color: "#4c4c4b"}}/> &nbsp; Helpful? &nbsp; &nbsp; 
      <button style={{color: "#4c4c4b", paddingTop: "15px"}} className="astext" onClick={() => {
        if( voted === false ){
        setYes(Yes + 1);
        setVote(true);
        }}} > Yes &nbsp;  </button> {`(${Yes})`} &nbsp;&nbsp;|  
